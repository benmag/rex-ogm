...
Client.prototype = {
    ...
    findRecords: function(searchParams) {
        ...
        self = this;
        var resolver = Promise.pending();
        var keyValueString = this._objectToKeyValueString(searchParams[0]);
        ...
        request.get(apiUrl, function(e,r,data) {
            ...
            if(data['message'] !== undefined) {
                ...
                resolver.fulfill(self._sortByBestMatch(searchParams, data.results));
            } else {
                resolver.fulfill([])    
            }
        });
            ...
            try {
                ...
                request.post({url: apiUrl}, function(e,r,data) {
                    ...
                    if(e) throw (e);
                        ...
                        if(data['matchesessage'] !== undefined) {
